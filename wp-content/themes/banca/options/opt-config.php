...
$args = array(
    ...
    'menu_title' => esc_html__('Theme Settings', 'banca'),
    'page_title' => esc_html__('Banca Theme Settings', 'banca'),
...
$args['footer_text'] = '<br>' . esc_html__('Copyright Banca &copy; 2022', 'banca');
...
require get_template_directory() . '/options/opt_dark_mode.php';
...
require get_template_directory() . '/options/opt_jobs.php';
