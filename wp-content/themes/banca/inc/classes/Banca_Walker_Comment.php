...
if ( ! class_exists('Banca_Walker_Comment') ) {
    /**
     * CUSTOM COMMENT WALKER
     * A custom walker for comments, based on the walker in Twenty Nineteen.
     */
    class Banca_Walker_Comment extends Walker_Comment {
                ...
                <div class="media-body">
                    <div class="comment_info">
                        ...
                        <?php comment_reply_link(array_merge(
                            $args,
                                array(
                                    'reply_text' => esc_html__('Reply', 'banca') . '<i class="'.esc_attr($arrow_icon ).'"></i>',
                                    'depth' => $depth,
                    ...
                    <?php if ( '0' === $comment->comment_approved ) : ?>
                        <em> <?php esc_html_e( 'Your comment is awaiting moderation.', 'banca' ) ?></em><br />
                    <?php endif; ?>
                    <?php comment_text(); ?>
                </div>
            </div>
